...
goog.exportSymbol('proto.models.TagQueryParams', null, global);
 ...
 * @constructor
 */
proto.models.TagQueryParams = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.models.TagQueryParams, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.models.TagQueryParams.displayName = 'proto.models.TagQueryParams';
}
 ...
 * @return {!Object}
 */
proto.models.TagQueryParams.prototype.toObject = function(opt_includeInstance) {
  return proto.models.TagQueryParams.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.models.TagQueryParams} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.models.TagQueryParams.toObject = function(includeInstance, msg) {
  var f, obj = {
    params: (f = msg.getParams()) && proto.models.QueryParams.toObject(includeInstance, f),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.models.TagQueryParams}
 */
proto.models.TagQueryParams.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.models.TagQueryParams;
  return proto.models.TagQueryParams.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.models.TagQueryParams} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.models.TagQueryParams}
 */
proto.models.TagQueryParams.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.models.TagQueryParams.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.models.TagQueryParams.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.models.TagQueryParams} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.models.TagQueryParams.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getParams();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.models.QueryParams}
 */
proto.models.TagQueryParams.prototype.getParams = function() {
  return /** @type{?proto.models.QueryParams} */ (
    jspb.Message.getWrapperField(this, proto.models.QueryParams, 1));
};
...
/**
 * @param {?proto.models.QueryParams|undefined} value
 * @return {!proto.models.TagQueryParams} returns this
*/
proto.models.TagQueryParams.prototype.setParams = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.models.TagQueryParams} returns this
 */
proto.models.TagQueryParams.prototype.clearParams = function() {
  return this.setParams(undefined);
};
 ...
 * @return {boolean}
 */
proto.models.TagQueryParams.prototype.hasParams = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.models.TagQueryParams.prototype.getTags = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.models.TagQueryParams} returns this
 */
proto.models.TagQueryParams.prototype.setTags = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
