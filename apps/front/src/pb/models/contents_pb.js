...
goog.exportSymbol('proto.models.QuizId', null, global);
/**
 ...
 * @constructor
 */
proto.models.QuizId = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.models.QuizId, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.models.QuizId.displayName = 'proto.models.QuizId';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.models.QuizId.prototype.toObject = function(opt_includeInstance) {
  return proto.models.QuizId.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.models.QuizId} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.models.QuizId.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 */
proto.models.QuizId.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.models.QuizId;
  return proto.models.QuizId.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.models.QuizId} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.models.QuizId}
 */
proto.models.QuizId.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.models.QuizId.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.models.QuizId.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.models.QuizId} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.models.QuizId.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.models.QuizId.prototype.getId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.models.QuizId} returns this
 */
proto.models.QuizId.prototype.setId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
...
proto.models.Quiz.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: (f = msg.getId()) && proto.models.QuizId.toObject(includeInstance, f),
...
proto.models.Quiz.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.models.QuizId;
      reader.readMessage(value,proto.models.QuizId.deserializeBinaryFromReader);
      msg.setId(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
...
proto.models.Quiz.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.models.QuizId.serializeBinaryToWriter
    );
  }
...
/**
 * optional QuizId id = 1;
 * @return {?proto.models.QuizId}
 */
proto.models.Quiz.prototype.getId = function() {
  return /** @type{?proto.models.QuizId} */ (
    jspb.Message.getWrapperField(this, proto.models.QuizId, 1));
};
 ...
 * @return {!proto.models.Quiz} returns this
 */
proto.models.Quiz.prototype.clearId = function() {
  return this.setId(undefined);
};
 ...
 * @return {boolean}
 */
proto.models.Quiz.prototype.hasId = function() {
  return jspb.Message.getField(this, 1) != null;
};
